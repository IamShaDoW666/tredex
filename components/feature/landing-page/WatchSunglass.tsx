    ...
    return (
        <div className="max-w-6xl mx-auto">
            ...
            <div className="flex justify-between px-4">
                <Card className="w-1/2 md:w-1/3 max-w-xl mr-2 min-h-[30vh] md:min-h-[400px] relative shadow">
                ...
                <Card className="w-1/2 md:w-1/3 max-w-xl ml-2 min-h-[30vh] md:min-h-[400px] relative rounded-xl shadow">
                    <Link passHref href="/collection?category=Sunglasses">
